const validate = values => {
    ...
    // // Upload File
    // if (!values.selfieIdCardFiles || values.selfieIdCardFiles.length < 1) {
    //     errors.selfieIdCardFiles = 'กรุณาอัพโหลดไฟล์อย่างน้อย 1 ไฟล์'
    // }
    // if (!values.salarySlipFiles || values.salarySlipFiles.length < 1) {
    //     errors.salarySlipFiles = 'กรุณาอัพโหลดไฟล์อย่างน้อย 1 ไฟล์'
    // }
    // if (!values.statement4MonthFiles || values.statement4MonthFiles.length < 1) {
    //     errors.statement4MonthFiles = 'กรุณาอัพโหลดไฟล์อย่างน้อย 1 ไฟล์'
    // }
    // if (!values.secondaryStatement4MonthFiles || values.secondaryStatement4MonthFiles.length < 1) {
    //     errors.secondaryStatement4MonthFiles = 'กรุณาอัพโหลดไฟล์อย่างน้อย 1 ไฟล์'
    // }
