                           ...
                           <div class="progress"> 
                            ...
                            <Field
                                ...
                                options={[
                                    ...
                                    { value: '2 - 5 เดือน', label: '2 - 5 เดือน' },
                                    { value: '6 - 12 เดือน', label: '6 - 12 เดือน' },
                                    { value: '1-2 ปี', label: '1-2 ปี' },
                                    { value: 'มากกว่า 2 ปี', label: 'มากกว่า 2 ปี' },
                                ]}
                            />
                            <Field
                                name="mobileAge"
                            ...
                            <Field
                                ...
                                options={[
                                    ...
                                    { value: 'อพาร์ตเม้นท์', label: 'อพาร์ตเม้นท์' }
                                ]}
                            />
                            <Field
                                name="homeStatus"
                                ...
                                options={[
                                    ...
                                    { value: 'บ้านบิดา/มารดา/ญาติ', label: 'บ้านบิดา/มารดา/ญาติ' },
                                    { value: 'บ้านพักสวัสดิการ', label: 'บ้านพักสวัสดิการ' },
                            ...
                            <Field
                                ...
                                label="การศึกษา"
                                options={[
                                    { value: 'ต่ำกว่ามัธยมปลาย/ปวช./เทียบเท่า', label: 'ต่ำกว่ามัธยมปลาย/ปวช./เทียบเท่า' },
                                    { value: 'อนุปริญญา/ปวส./เทียบเท่า', label: 'อนุปริญญา/ปวส./เทียบเท่า' },
                                    { value: 'ปริญญาตรี', label: 'ปริญญาตรี' },
                                    { value: 'สูงกว่าปริญญาตรี', label: 'สูงกว่าปริญญาตรี' },
                                ]}
                            />
                            <Field
                                name="status"
                                ...
                                options={[
                                    { value: 'โสด', label: 'โสด' },
                                    { value: 'สมรสจดทะเบียน', label: 'สมรสจดทะเบียน' },
                                    { value: 'สมรสไม่จดทะเบียน', label: 'สมรสไม่จดทะเบียน' },
                                    { value: 'หย่า / หม้าย', label: 'หย่า / หม้าย' },
                                ]}
                            />
                            ...
                            <Field
                                ...
                                options={[
                                    ...
                                    { value: 'เพื่อนร่วมงาน', label: 'เพื่อนร่วมงาน' },
                                ]}
                            />
                            ...
                            <Field
                                ...
                                options={[
                                    ...
                                    { value: 'ตำรวจ/ทหาร', label: 'ตำรวจ/ทหาร' },
                                    { value: 'แพทย์', label: 'แพทย์' },
                                    { value: 'พยาบาล', label: 'พยาบาล' },
                                    { value: 'ธุรการ', label: 'ธุรการ' },
                                    { value: 'พนักงานสายการผลิต', label: 'พนักงานสายการผลิต' },
                                    { value: 'พนักงานบัญชี/การเงิน', label: 'พนักงานบัญชี/การเงิน' },
                                    { value: 'ักษาความปลอดภัย', label: 'ักษาความปลอดภัย' },
                                    { value: 'แม่บ้าน', label: 'แม่บ้าน' },
                                    { value: 'เจ้าของกิจการ(จดทะเบียนนิติบุคคล)', label: 'เจ้าของกิจการ(จดทะเบียนนิติบุคคล)' },
                                    { value: 'เจ้าของกิจการ/ร้านค้า(ไม่จดทะเบียนนิติบุคคล)', label: 'เจ้าของกิจการ/ร้านค้า(ไม่จดทะเบียนนิติบุคคล)' },
                                    { value: 'พ่อค้า/แม่ค้า', label: 'พ่อค้า/แม่ค้า' },
                                    { value: 'ขับแท็กซี่ วินมอเตอร์ไซด์', label: 'ขับแท็กซี่ วินมอเตอร์ไซด์' },
                                    { value: 'ว่างงาน', label: 'ว่างงาน' },
                                ]}
                            />
                            <Field
                                name="workStatus"
                                ...
                                options={[
                                    ...
                                    { value: 'พนักงานชั่วคราว', label: 'พนักงานชั่วคราว' },
                                    { value: 'พนักงานรายวัน', label: 'พนักงานรายวัน' },
                                    { value: 'ว่างงาน', label: 'ว่างงาน' },
                                ]}
                            />
                            <Field
                            ...
                            <Field
                                ...
                                options={[
                                    ...
                                    { value: '2-10 คน', label: '2-10 คน' },
                                    { value: '11-50 คน', label: '11-50 คน' },
                                    { value: '51-100 คน', label: '51-100 คน' },
                                    { value: '101-1000 คน', label: '101-1000 คน' },
                                    { value: 'มากกว่า 1000', label: 'มากกว่า 1000' },
                                ]}
                            />
                            <Field
                                name="workPosition"
                            ...
                            <Field
                                ...
                                options={[
                                    { value: 'โอนผ่านธนาคาร', label: 'โอนผ่านธนาคาร' },
                                    { value: 'รับเป็นเช็ค', label: 'รับเป็นเช็ค' },
                                    { value: 'รับเป็นเงินสด', label: 'รับเป็นเงินสด' }
                                ]}
                            />
                            <Field
                                name="getSalaryTimes"
                            ...
                            <Field
                                ...
                                options={[
                                    { value: 'สมัครแล้วไม่ผ่าน', label: 'สมัครแล้วไม่ผ่าน' },
                                    { value: 'มี แต่วงเงินเต็ม', label: 'มี แต่วงเงินเต็ม' },
                                    { value: 'มี วงเงินเหลือ', label: 'มี วงเงินเหลือ' },
                                    { value: 'ไม่สมัคร', label: 'ไม่สมัคร' },
                                ]}
                            />
                            <Field
                                name="cashDebt"
                            ...
                            <Field
                                ...
                                options={[
                                    { value: '0 ครั้ง', label: '0 ครั้ง' },
                                    { value: '1-2', label: '1-2' },
                                    { value: '3-5', label: '3-5' },
                                    { value: 'มากกว่า 5 ครั้ง', label: 'มากกว่า 5 ครั้ง' },
                                ]}
                            />
                            <Field
                                name="familySpending"
